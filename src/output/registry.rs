...
use crate::output::traits::{OutputRegistry, OutputGenerator, FormatWriter};
...
mod tests {
    ...
    fn test_register_generator_info() {
        ...
        assert!(registry.get_generator_info("test_generator").unwrap().is_some());
    }
    ...
    fn test_increment_usage() {
        ...
        let updated_info = registry.get_generator_info("test_generator").unwrap().unwrap();
